...
def build_retrieval_dataset(
    *,
    ...
    document_payloads = _document_payloads(parsed_source)
...
def _document_payloads(parsed_source: ParsedSource) -> list[dict[str, Any]]:
    payloads = []
    used_keys: set[str] = set()
    source_type = parsed_source.source_file_name.rsplit(".", maxsplit=1)[-1].lower()
